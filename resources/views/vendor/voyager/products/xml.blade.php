...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.($edit ? 'edit' : 'add')).' '.$dataType->getTranslatedAttribute('display_name_singular') . ' XML' }}
    </h1>
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @if($row->getTranslatedAttribute('display_name') == 'categories')
                            ...
                            <div class="form-group  col-md-12 ">
                                <label class="control-label" for="name">XML URL</label><br>
                                <input type="text" class="form-control" name="xmlurl" placeholder="http://" value="">
                            </div>
