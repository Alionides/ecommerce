	...
	<div class="container">
    	<div class="row">
                        ...
                        <div class="product">
                            ...
                            <div class="product_info">                                
                                ...
                                <div class="rating_wrap">
                                    <div class="rating">
                                        <div class="product_rate" style="width:{{reviewPercent($d->reviews,count($d->reviews))}}%"></div>
                                    </div>
                                    <span class="rating_num">({{count($d->reviews)}})</span>
                                </div>
                                {{-- <div class="rating_wrap">
                                    <div class="rating">
            ...
            <div class="col-lg-3 order-lg-first mt-4 pt-2 mt-lg-0 pt-lg-0">
            	<div class="sidebar">
                	<div class="widget">
                        <h5 class="widget_title">{{__('lang.category')}}</h5>
